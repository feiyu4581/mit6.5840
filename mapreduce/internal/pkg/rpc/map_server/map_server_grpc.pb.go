...
type MapClient interface {
	...
	NewTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskStatus, error)
}
...
func (c *mapClient) NewTask(ctx context.Context, in *Task, opts ...grpc.CallOption) (*TaskStatus, error) {
	out := new(TaskStatus)
...
type MapServer interface {
	// 尝试一下返回值中直接返回 error，看看效果
	NewTask(context.Context, *Task) (*TaskStatus, error)
...
func (UnimplementedMapServer) NewTask(context.Context, *Task) (*TaskStatus, error) {
